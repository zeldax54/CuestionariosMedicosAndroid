...
public class MeningCont extends FragmentActivity implements TabListener{
		private ViewPager vPager;
		private MeningTabsAdapter tAdapter;
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			setContentView(R.layout.meningprinc);
			...
			tAdapter = new MeningTabsAdapter(getSupportFragmentManager(),bandera,caso_id);
			...
			for (String title : getResources().getStringArray(R.array.tabsm)) {
