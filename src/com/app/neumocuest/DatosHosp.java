...
public class DatosHosp extends FragmentActivity implements TabListener {
	private ViewPager vPager;
	private DatosHospTabsAdapter tAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datoshospprinc);
		...
		tAdapter = new DatosHospTabsAdapter(getSupportFragmentManager(),bandera,caso_id);
