...
public class APSCont extends FragmentActivity implements TabListener{
	private ViewPager vPager;
	private APSTabsAdapter tAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tAdapter = new APSTabsAdapter(getSupportFragmentManager(),bandera,caso_id);
